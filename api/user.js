...
export function getCateList(data) {
	return request.get("/categorie/list", data || {});
}
...
export function getAddressList(data) {
	return request.get("/addre/list", data || {});
}
...
export function getAddress(id) {
	return request.get("/addre/detail/" + id);
}
...
export function postAddress(data) {
	return request.get("/addre/edit", data);
}
